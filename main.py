...
def runParallel(configFileName,path,fileName,ra,dec,xtraID,saveResult):
    ...
    m.run(path,fileName,maskFile,saveResult,ra=ra,dec=dec, saveFig=saveFig, clear=True, clip=clip, xtraID=xtraID)
